...
#config data
#and make sure the config file in /home/R/config.ini
confdata<-NULL
config<-NULL
tryCatch({
...
#return the content or on error return NULL
...
#raw<-getRawHtml(logname="test.log",url="http://sc.sina.com.cn/news/d/2012-08-30/110022581.html")
#print(raw);
#content<-extract(raw)
#	print(content)
#print(content)
